...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"></h6> Edycja użytkownika</h6>
        </div>
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="id" value="${user.id}"/><br/>
                ...
                <div class="form-group">
                    ...
                    <input value="${user.email}" name="email" type="email" class="form-control" id="email" placeholder="Adres e- mail">
                </div>
                <div class="form-group">
